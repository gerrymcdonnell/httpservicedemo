...
export class DataService2 {
    ...
    RESTUrl:string='http://localhost/cake3restapi2/words.json';
  ...
  //worked
  deleteWord(id){
    return this.http.delete('http://localhost/cake3restapi2/words/'+id+'.json')
    .map(res=>res.json());
  }
  ...
  updateWord(word){
      ...
      console.log(word);
      return this.http.put('http://localhost/cake3restapi2/words/'+word.id+'.json', word)
